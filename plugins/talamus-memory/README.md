...
```bash
uvx --from "talamus[mcp]==1.1.3" talamus init
```
...
the workspace. Do not run the installer itself through `uvx`: version 1.1.3
...
uvx --from "talamus[mcp]==1.1.3" talamus-mcp --help
```
