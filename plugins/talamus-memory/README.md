...
```bash
uvx --from "talamus[mcp]==1.1.1" talamus init
```
...
the workspace. Do not run the installer itself through `uvx`: version 1.1.1
...
uvx --from "talamus[mcp]==1.1.1" talamus-mcp --help
```
