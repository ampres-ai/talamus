...
```text
uvx --from "talamus[mcp]==1.1.2" talamus
```
...
```bash
uvx --from "talamus[mcp]==1.1.2" talamus where --json
uvx --from "talamus[mcp]==1.1.2" talamus status --json
```
...
```bash
uvx --from "talamus[mcp]==1.1.2" talamus search "query" --json
uvx --from "talamus[mcp]==1.1.2" talamus recall "question" --json
uvx --from "talamus[mcp]==1.1.2" talamus read "note title" --json
uvx --from "talamus[mcp]==1.1.2" talamus history "note title" --json
uvx --from "talamus[mcp]==1.1.2" talamus timeline "note title" --json
uvx --from "talamus[mcp]==1.1.2" talamus neighbors "concept" --json
uvx --from "talamus[mcp]==1.1.2" talamus relations --json
uvx --from "talamus[mcp]==1.1.2" talamus ontology status --json
uvx --from "talamus[mcp]==1.1.2" talamus review list --json
uvx --from "talamus[mcp]==1.1.2" talamus doctor
```
...
```bash
uv tool install "talamus[mcp]==1.1.2"
```
...
Do not use `uvx --from "talamus[mcp]==1.1.2" talamus mcp install --agent
