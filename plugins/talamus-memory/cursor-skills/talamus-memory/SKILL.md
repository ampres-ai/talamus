...
```text
uvx --from "talamus[mcp]==1.1.3" talamus
```
...
```bash
uvx --from "talamus[mcp]==1.1.3" talamus where --json
uvx --from "talamus[mcp]==1.1.3" talamus status --json
```
...
```bash
uvx --from "talamus[mcp]==1.1.3" talamus search "query" --json
uvx --from "talamus[mcp]==1.1.3" talamus recall "question" --json
uvx --from "talamus[mcp]==1.1.3" talamus read "note title" --json
uvx --from "talamus[mcp]==1.1.3" talamus history "note title" --json
uvx --from "talamus[mcp]==1.1.3" talamus timeline "note title" --json
uvx --from "talamus[mcp]==1.1.3" talamus neighbors "concept" --json
uvx --from "talamus[mcp]==1.1.3" talamus relations --json
uvx --from "talamus[mcp]==1.1.3" talamus ontology status --json
uvx --from "talamus[mcp]==1.1.3" talamus review list --json
uvx --from "talamus[mcp]==1.1.3" talamus doctor
```
...
```bash
uv tool install "talamus[mcp]==1.1.3"
```
...
Do not use `uvx --from "talamus[mcp]==1.1.3" talamus mcp install --agent
