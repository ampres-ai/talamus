...
# via config.provider_models. Codex lineup re-verified live 2026-07-14 on CLI 0.144.4
# (ChatGPT account): gpt-5.6-sol is the new flagship (accepts
# model_reasoning_effort up to xhigh), gpt-5.5 remains available, gpt-5.4-mini stays
# the fast/cheap tier — no 5.6-class mini exists.
_TIER_MODELS: dict[str, dict[str, str]] = {
    "claude-cli": {"economy": "haiku", "quality": "opus"},
    "codex-cli": {"economy": "gpt-5.4-mini", "quality": "gpt-5.6-sol"},
