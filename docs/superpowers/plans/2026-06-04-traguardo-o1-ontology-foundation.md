...
**Files:** Create `src/kortex/ontology.py`; Test `tests/test_kortex_ontology.py`.
...
**Files:** Modify `src/kortex/ontology.py`; Test `tests/test_kortex_ontology.py`.
...
**Files:** Modify `src/kortex/paths.py`, `src/kortex/store.py`; Test `tests/test_kortex_store.py`.

- `KortexPaths.ontology_file` → `.kortex/cache/ontology.json`.
...
**Files:** Modify `src/kortex/recall.py`, `src/kortex/cli.py`, `src/kortex/mcp_server.py`; Test relativi.

- `recall.concept_neighbors(paths, concept) -> list[dict]`: carica l'ontologia e chiama `neighbors`.
- CLI `kortex neighbors <concetto> --root`: stampa i vicini tipizzati.
